...
SECRET_KEY = 'django-insecure-#=4&u=0v&w2()s3a@=q-355eb$8mlagr24iiqi)9*zs6g3sisu'
...
INSTALLED_APPS = [
    ...
    'clinic_bill.apps.ClinicBillConfig',
    'complaint.apps.ComplaintConfig',
    'doctor.apps.DoctorConfig',
    'doctor_schedule.apps.DoctorScheduleConfig',
    'feedback.apps.FeedbackConfig',
    'login.apps.LoginConfig',
    'payment.apps.PaymentConfig',
    'pharmacy.apps.PharmacyConfig',
    'pharmacy_bill.apps.PharmacyBillConfig',
